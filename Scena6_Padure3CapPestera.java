...
public class Scena6_Padure3CapPestera extends World
{
    
    public static boolean exitOnLeft_s2;
    public Scena6_Padure3CapPestera()
    {    
    ...
    private void prepare()
    {
        ...
        Control_Scene.scenaCurenta = 6;
        
        
        BG1.limEdgeSt = 1989; //Cat de mult de poti duce in stanga -def 1999
        BG1.limEdgeDr = 1850; //Cat de mult de poti duce in dreapta -def 501
        ...
        fg0.setImage(new GreenfootImage("CapPestera.png"));
