...
public class Scena8_PadureNoapte1 extends World
{
    

    public Scena8_PadureNoapte1()
    {    
    ...
    private void prepare()
    {
        ...
        addObject(bg0,1900,300);
        addObject(bg1,1900,368);
        addObject(bg2,1900,300);
        addObject(player,30,485);
        BG1.limEdgeSt = 1899; //Cat de mult de poti duce in stanga -def 1999
